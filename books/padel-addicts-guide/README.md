# The Padel Addict's Guide to Talking About Anything Else

Book Factory project `padel-addicts-guide`.
...
```bash
bookfactory status padel-addicts-guide
bookfactory next padel-addicts-guide
```
